...
const assets = new Map(['index.html','studio.css','studio.js','model.mjs','tutorial.mjs','favicon.svg'].map(name=>['/v2/'+name,name]));
...
http.createServer((req,res)=>{
  ...
  res.setHeader('Content-Type',name.endsWith('.svg')?'image/svg+xml':name.endsWith('.html')?'text/html; charset=utf-8':name.endsWith('.css')?'text/css; charset=utf-8':'text/javascript; charset=utf-8');
